	 ...
	 <div id="contenido">
			...
			<form name="abc" action="resABCCliente.php" method="post" 
				...
				?>
					...
					<input type="hidden" name="txtClave" value="<?php echo $oClien->getClave();?>"/>
				<?php
					}
				?>
				<br/>
				...
				<input type="text" name="txtNombre" 
					<?php echo ($bCampoEditable==true?'':' disabled ');?>
					value="<?php echo ($bLlaveEditable==true?'':$oClien->getNombre());?>"/>
				<br/>
				Apellido Paterno
				<input type="text" name="txtApePat" 
					<?php echo ($bCampoEditable==true?'':' disabled ');?>
					value="<?php echo ($bLlaveEditable==true?'':$oClien->getApePat());?>"/>
				<br/>
				Apellido Materno
				<input type="text" name="txtApeMat" 
					<?php echo ($bCampoEditable==true?'':' disabled ');?>
					value="<?php echo ($bLlaveEditable==true?'':$oClien->getApeMat());?>"/>
				<br/>
				Numero Control
				<input type="number" name="txtNumero" 
					<?php echo ($bCampoEditable==true?'':' disabled ');?>
					value="<?php echo ($bLlaveEditable==true?'':$oClien->getNumControl());?>"/>
				<br/>
			    Area
				<input type="number" name="txtCveArea" 
					<?php echo ($bCampoEditable==true?'':' disabled ');?>
					value="<?php echo ($bLlaveEditable==true?'':$oClien->getCveArea()); error_log($oClien->getCveArea(),"Clave area",0);?>"/>
				<br/>
                <br/>
